...
export class EmpListComponent implements OnInit {
 ...
 getEmpbyjob()
 {
   this.dataservice.GetEmployeeByJob("Manager").subscribe(
     resData => 
     {
       this.result = resData;
     }
 ...
 {
   this.dataservice.GetManagerByDepartment(10).subscribe(
     resData =>
     {
       this.result = resData;
     }
 ...
 GetAllEmpwithJob()
 {
   this.dataservice.GetAllEmpwithJob().subscribe(
     resData =>
     {
       this.result = resData;
     }
 ...
 GetEmpWithoutSpecificDept()
 {
   this.dataservice.GetEmpWithoutSpecificDept(10).subscribe(
    resData =>
    {
      this.result = resData;
    }
 ...
 SortEmpBasedOnSal()
 {
   this.dataservice.SortEmpBasedOnSal().subscribe(
    resData =>
    {
      this.result = resData;
    }
